...
class ChatService:
    ...
    def hostChat(self):
        """
        Hosts a chat, listens for an initial connection, then starts a thread to listen for more connections
        """
    ...
    def handleConnection(self, conn: tuple[str, int], addr: tuple[str, int]):
        """
    ...
    def distributeMessage(self, senderConn: tuple[str, int], data: bytes):
        """
